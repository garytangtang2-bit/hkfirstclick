...
"days":[{"date":"2026-02-23","theme":"Arrival","activities":[{"time":"14:00","title":"從住宿出發","description":"準備開始精彩旅程","location":"真實地點名稱","cost":"0","costNumber":0,"needsTicket":false,"transitToNext":{"mode":"捷運 (機場專線)","duration":"約 45 分鐘"}}]}]
}`;
