...
5.**地點與交通文字格式**: 
 ...
 - **🚨餐廳與美食規定 (isFood = true)**: 只要是早餐、午餐、晚餐、宵夜或吃甜點，**絕對不能使用像是「市區午餐」這種籠統詞語**。你必須直接寫出「當地確實存在的真實餐廳名稱」，並在名稱前方加上城市名 (例如: "香港尖沙咀華嫂冰室" 或 "東京敘敘苑 新宿中央東口店")。這會直接連動到使用者的 Google地圖導航，如果亂寫會讓網頁體驗非常差。
